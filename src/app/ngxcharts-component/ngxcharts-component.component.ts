...
@Component({
  selector: 'app-ngxcharts-component',
  templateUrl: './ngxcharts-component.component.html',
  styleUrls: ['./ngxcharts-component.component.css']
})
export class NGXChartsComponentComponent implements OnInit {
  _single=single;
  _multi=multi;
  _bubble=bubble;
  _timelineFilterBarData=timelineFilterBarData;
  _fiscalYearReport=fiscalYearReport;
  constructor() { }
  @Input('chartType') chartType:string;
  _dateDataWithOrWithoutRange = [
    {
        "name": "Germany",
        "series": [
        {
